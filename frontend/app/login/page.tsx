...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <div className="animated-bg relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm mx-4">
          ...
          >
            ...
            <ul className="mb-8 space-y-2.5">
              {[
                'Auto-parse transaction emails',
                'Spending insights & trends',
                'Track across all your cards',
              ].map((text) => (
